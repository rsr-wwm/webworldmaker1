import { $ as MiddlewareNoDataOrNextCalled, A as REDIRECT_STATUS_CODES, B as ActionsReturnedInvalidDataError, C as renderEndpoint, D as ASTRO_ERROR_HEADER, E as isRoute500, F as originPathnameSymbol, G as GetStaticPathsExpectedParams, H as CacheNotEnabled, I as pipelineSymbol, K as GetStaticPathsInvalidRouteParam, L as responseSentSymbol$1, M as appSymbol, N as clientAddressSymbol, O as ASTRO_GENERATOR, P as fetchStateSymbol, Q as LocalsReassigned, R as AstroError, T as isRoute404, U as ClientAddressNotAvailable, V as AstroResponseHeadersReassigned, W as ForbiddenRewrite, X as InvalidGetStaticPathsReturn, Y as InvalidGetStaticPathsEntry, Z as LocalsNotAnObject, a as chunkToString, at as ReservedSlotName, b as pushDirective, c as renderSlotToString, ct as SessionStorageInitError, d as decodeKey, dt as UnableToLoadLogger, et as MiddlewareNotAResponse, f as decryptString, ft as i18nNoLocaleFoundInPath, it as PrerenderDynamicEndpointPathCollide, j as REROUTABLE_STATUS_CODES, k as DEFAULT_404_COMPONENT, l as isRenderTemplateResult, lt as SessionStorageSaveError, n as renderJSX, nt as PageNumberParamNotFound, o as createSlotValueFromString, ot as ResponseSentError, p as generateCspDigest, q as GetStaticPathsRequired, r as renderComponent, rt as PrerenderClientAddressNotAvailable, st as RewriteWithBodyUsed, t as renderPage, tt as NoMatchingStaticPathFound, u as renderTemplate, ut as StaticClientAddressNotAvailable, v as isRenderInstruction, x as isAstroComponentFactory, y as normalizeCspResourceEntry, z as ActionNotFoundError } from "./chunks/server_DcTmh7p-.mjs";
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"SITE": "https://webworldmaker.com",
			"SSR": true
		}, { _: "/Users/apple/Downloads/webworldmaker/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://webworldmaker.com",
			"SSR": true
		}, { _: "/Users/apple/Downloads/webworldmaker/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"redirectRoute": {
				...
				"params": [],
				"component": "src/pages/company/about.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["...slug"],
			"component": "src/pages/ai/[...slug].ts",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"redirectRoute": {
				...
				"params": [],
				"component": "src/pages/company/careers.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/case-studies.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/company/index.astro",
			"pathname": "/company",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/compare/[id].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/compare/index.astro",
			"pathname": "/compare",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/corrections.astro",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/developer/api-reference",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/developer\\/api-reference\\/?$",
			"segments": [[{
				"content": "developer",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/developer/api-reference.astro",
			"pathname": "/developer/api-reference",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/industry-solutions/[id]",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/industry-solutions\\/([^/]+?)\\/?$",
			"segments": [[{
			...
			"params": ["id"],
			"component": "src/pages/industry-solutions/[id].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/industry-solutions/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/location/[id].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["state", "city"],
			"component": "src/pages/locations/[state]/[city].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/locations.astro",
			"pathname": "/locations",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/partners/partner-program",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/partners\\/partner-program\\/?$",
			"segments": [[{
				"content": "partners",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/partners/partner-program.astro",
			"pathname": "/partners/partner-program",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/partners/index.astro",
			"pathname": "/partners",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/problem/[id].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/problems.astro",
			"pathname": "/problems",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/resources/blog/[id].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/resources/blog/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/sandbox.astro",
			"pathname": "/sandbox",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			"type": "redirect",
			"isIndex": false,
			"route": "/search-growth/aeo",
			"pattern": "^\\/search-growth\\/aeo\\/?$",
			"segments": [[{
				"content": "search-growth",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "aeo",
			...
			"params": [],
			"component": "/search-growth/aeo",
			"pathname": "/search-growth/aeo",
			"prerender": true,
			"redirect": {
				"status": 301,
				"destination": "/search-growth/aeo-services"
			},
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			"type": "redirect",
			"isIndex": false,
			"route": "/search-growth/geo",
			"pattern": "^\\/search-growth\\/geo\\/?$",
			"segments": [[{
				"content": "search-growth",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "/search-growth/geo",
			"pathname": "/search-growth/geo",
			"prerender": true,
			"redirect": {
				"status": 301,
				"destination": "/search-growth/geo-services"
			},
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			"type": "redirect",
			"isIndex": false,
			"route": "/search-growth/seo",
			"pattern": "^\\/search-growth\\/seo\\/?$",
			"segments": [[{
				"content": "search-growth",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "/search-growth/seo",
			"pathname": "/search-growth/seo",
			"prerender": true,
			"redirect": {
				"status": 301,
				"destination": "/search-growth/seo-services"
			},
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/social-media.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/solution/[id].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["name"],
			"component": "src/pages/team/[name].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/technology-consultancy",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/technology-consultancy\\/?$",
			"segments": [[{
			...
			"params": [],
			"component": "src/pages/technology-consultancy.astro",
			"pathname": "/technology-consultancy",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/three-demo.astro",
			"pathname": "/three-demo",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/[categoryId]/[serviceId]/[state]/[city]",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/?$",
			"segments": [
			...
			"component": "src/pages/[categoryId]/[serviceId]/[state]/[city].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"component": "src/pages/[categoryId]/[serviceId].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["categoryId"],
			"component": "src/pages/[categoryId].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/403_DGzgq6aQ.mjs");
var _page1 = () => import("./chunks/404_BhE_gwGp.mjs");
var _page2 = () => import("./chunks/500_BCcSiJOY.mjs");
var _page3 = () => import("./chunks/index_Dts89SyA.mjs");
var _page4 = () => import("./chunks/_.._Kz8t1zzF.mjs");
var _page5 = () => import("./chunks/case-studies_rh7kotsI.mjs");
var _page6 = () => import("./chunks/about_DCM781mt.mjs");
var _page7 = () => import("./chunks/careers_k-qTp6ba.mjs");
var _page8 = () => import("./chunks/index_BKvwvEyY.mjs");
var _page9 = () => import("./chunks/_id__BM4cmcI2.mjs");
var _page10 = () => import("./chunks/index_CC_uFPZN.mjs");
var _page11 = () => import("./chunks/contact_CcveUQPz.mjs");
var _page12 = () => import("./chunks/corrections_GRQ3ck_2.mjs");
var _page13 = () => import("./chunks/api-reference_A7etqP9R.mjs");
var _page14 = () => import("./chunks/_term__Cps2wW0q.mjs");
var _page15 = () => import("./chunks/index_Dsj8Yru5.mjs");
var _page16 = () => import("./chunks/_id__0bxdrhoE.mjs");
var _page17 = () => import("./chunks/index_D1_AaGZu.mjs");
var _page18 = () => import("./chunks/_id__CrWlCH_g.mjs");
var _page19 = () => import("./chunks/_city__DmCJ3r5a.mjs");
var _page20 = () => import("./chunks/locations_D9oNJEMS.mjs");
var _page21 = () => import("./chunks/partner-program_COgVbDMy.mjs");
var _page22 = () => import("./chunks/index_83jSE0HG.mjs");
var _page23 = () => import("./chunks/pricing_CO7rD0zj.mjs");
var _page24 = () => import("./chunks/privacy_Cnc14ZYc.mjs");
var _page25 = () => import("./chunks/_id__BnbxG9qh.mjs");
var _page26 = () => import("./chunks/problems_CGKlCjKG.mjs");
var _page27 = () => import("./chunks/_id__EI2HMIEL.mjs");
var _page28 = () => import("./chunks/products_B8jgjtVO.mjs");
var _page29 = () => import("./chunks/_id__yPta7d3N.mjs");
var _page30 = () => import("./chunks/index_B5TjvVg5.mjs");
var _page31 = () => import("./chunks/faqs_5z7EvlwU.mjs");
var _page32 = () => import("./chunks/sandbox_Bedr69VP.mjs");
var _page33 = () => import("./chunks/services_BnzGpRNG.mjs");
var _page34 = () => import("./chunks/sitemap_DP9tKmsk.mjs");
var _page35 = () => import("./chunks/social-media_BNeBcYEJ.mjs");
var _page36 = () => import("./chunks/_id__DvaPdsHN.mjs");
var _page37 = () => import("./chunks/solutions_BgoWBSDI.mjs");
var _page38 = () => import("./chunks/_name__BHCRZ6dH.mjs");
var _page39 = () => import("./chunks/technology-consultancy_5YJwkh9T.mjs");
var _page40 = () => import("./chunks/terms_02gYp8-a.mjs");
var _page41 = () => import("./chunks/three-demo_CV5GkSam.mjs");
var _page42 = () => import("./chunks/_city__CTe1Ms3o.mjs");
var _page43 = () => import("./chunks/_serviceId__BfCEx1Kl.mjs");
var _page44 = () => import("./chunks/_categoryId__BNQqGdft.mjs");
var _page45 = () => import("./chunks/index_BLgCVe53.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["src/pages/403.astro", _page0],
	["src/pages/404.astro", _page1],
	["src/pages/500.astro", _page2],
	["src/pages/admin/index.astro", _page3],
	["src/pages/ai/[...slug].ts", _page4],
	["src/pages/case-studies.astro", _page5],
	["src/pages/company/about.astro", _page6],
	["src/pages/company/careers.astro", _page7],
	["src/pages/company/index.astro", _page8],
	["src/pages/compare/[id].astro", _page9],
	["src/pages/compare/index.astro", _page10],
	["src/pages/contact.astro", _page11],
	["src/pages/corrections.astro", _page12],
	["src/pages/developer/api-reference.astro", _page13],
	["src/pages/glossary/[term].astro", _page14],
	["src/pages/glossary/index.astro", _page15],
	["src/pages/industry-solutions/[id].astro", _page16],
	["src/pages/industry-solutions/index.astro", _page17],
	["src/pages/location/[id].astro", _page18],
	["src/pages/locations/[state]/[city].astro", _page19],
	["src/pages/locations.astro", _page20],
	["src/pages/partners/partner-program.astro", _page21],
	["src/pages/partners/index.astro", _page22],
	["src/pages/pricing.astro", _page23],
	["src/pages/privacy.astro", _page24],
	["src/pages/problem/[id].astro", _page25],
	["src/pages/problems.astro", _page26],
	["src/pages/product/[id].astro", _page27],
	["src/pages/products.astro", _page28],
	["src/pages/resources/blog/[id].astro", _page29],
	["src/pages/resources/blog/index.astro", _page30],
	["src/pages/resources/faqs.astro", _page31],
	["src/pages/sandbox.astro", _page32],
	["src/pages/services.astro", _page33],
	["src/pages/sitemap.astro", _page34],
	["src/pages/social-media.astro", _page35],
	["src/pages/solution/[id].astro", _page36],
	["src/pages/solutions.astro", _page37],
	["src/pages/team/[name].astro", _page38],
	["src/pages/technology-consultancy.astro", _page39],
	["src/pages/terms.astro", _page40],
	["src/pages/three-demo.astro", _page41],
	["src/pages/[categoryId]/[serviceId]/[state]/[city].astro", _page42],
	["src/pages/[categoryId]/[serviceId].astro", _page43],
	["src/pages/[categoryId].astro", _page44],
	["src/pages/index.astro", _page45]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Users/apple/Downloads/webworldmaker/","cacheDir":"file:///Users/apple/Downloads/webworldmaker/node_modules/.astro/","outDir":"file:///Users/apple/Downloads/webworldmaker/dist/","srcDir":"file:///Users/apple/Downloads/webworldmaker/src/","publicDir":"file:///Users/apple/Downloads/webworldmaker/public/","buildClientDir":"file:///Users/apple/Downloads/webworldmaker/dist/client/","buildServerDir":"file:///Users/apple/Downloads/webworldmaker/dist/server/","adapterName":"","assetsDir":"assets","routes":[{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/403","isIndex":false,"type":"page","pattern":"^\\/403\\/?$","segments":[[{"content":"403","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/403.astro","pathname":"/403","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/404","isIndex":false,"type":"page","pattern":"^\\/404\\/?$","segments":[[{"content":"404","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/404.astro","pathname":"/404","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/500","isIndex":false,"type":"page","pattern":"^\\/500\\/?$","segments":[[{"content":"500","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/500.astro","pathname":"/500","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/about","pattern":"^\\/about\\/?$","segments":[[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"/about","pathname":"/about","prerender":true,"redirect":{"status":301,"destination":"/company/about"},"redirectRoute":{"route":"/company/about","isIndex":false,"type":"page","pattern":"^\\/company\\/about\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}],[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/company/about.astro","pathname":"/company/about","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/admin","isIndex":true,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/index.astro","pathname":"/admin","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"route":"/ai/[...slug]","isIndex":false,"type":"endpoint","pattern":"^\\/ai(?:\\/(.*?))?\\/?$","segments":[[{"content":"ai","dynamic":false,"spread":false}],[{"content":"...slug","dynamic":true,"spread":true}]],"params":["...slug"],"component":"src/pages/ai/[...slug].ts","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/careers","pattern":"^\\/careers\\/?$","segments":[[{"content":"careers","dynamic":false,"spread":false}]],"params":[],"component":"/careers","pathname":"/careers","prerender":true,"redirect":{"status":301,"destination":"/company/careers"},"redirectRoute":{"route":"/company/careers","isIndex":false,"type":"page","pattern":"^\\/company\\/careers\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}],[{"content":"careers","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/company/careers.astro","pathname":"/company/careers","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/case-studies","isIndex":false,"type":"page","pattern":"^\\/case-studies\\/?$","segments":[[{"content":"case-studies","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/case-studies.astro","pathname":"/case-studies","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/company/about","isIndex":false,"type":"page","pattern":"^\\/company\\/about\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}],[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/company/about.astro","pathname":"/company/about","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/company/about-us","pattern":"^\\/company\\/about-us\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}],[{"content":"about-us","dynamic":false,"spread":false}]],"params":[],"component":"/company/about-us","pathname":"/company/about-us","prerender":true,"redirect":{"status":301,"destination":"/company/about"},"redirectRoute":{"route":"/company/about","isIndex":false,"type":"page","pattern":"^\\/company\\/about\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}],[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/company/about.astro","pathname":"/company/about","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/company/careers","isIndex":false,"type":"page","pattern":"^\\/company\\/careers\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}],[{"content":"careers","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/company/careers.astro","pathname":"/company/careers","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/company/contact","pattern":"^\\/company\\/contact\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}],[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"/company/contact","pathname":"/company/contact","prerender":true,"redirect":{"status":301,"destination":"/contact"},"redirectRoute":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.astro","pathname":"/contact","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/company","isIndex":true,"type":"page","pattern":"^\\/company\\/?$","segments":[[{"content":"company","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/company/index.astro","pathname":"/company","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/compare/[id]","isIndex":false,"type":"page","pattern":"^\\/compare\\/([^/]+?)\\/?$","segments":[[{"content":"compare","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/compare/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/compare","isIndex":true,"type":"page","pattern":"^\\/compare\\/?$","segments":[[{"content":"compare","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compare/index.astro","pathname":"/compare","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.astro","pathname":"/contact","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/contact-us","pattern":"^\\/contact-us\\/?$","segments":[[{"content":"contact-us","dynamic":false,"spread":false}]],"params":[],"component":"/contact-us","pathname":"/contact-us","prerender":true,"redirect":{"status":301,"destination":"/contact"},"redirectRoute":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.astro","pathname":"/contact","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/corrections","isIndex":false,"type":"page","pattern":"^\\/corrections\\/?$","segments":[[{"content":"corrections","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/corrections.astro","pathname":"/corrections","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/developer/api-reference","isIndex":false,"type":"page","pattern":"^\\/developer\\/api-reference\\/?$","segments":[[{"content":"developer","dynamic":false,"spread":false}],[{"content":"api-reference","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/developer/api-reference.astro","pathname":"/developer/api-reference","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/diagnostics","pattern":"^\\/diagnostics\\/?$","segments":[[{"content":"diagnostics","dynamic":false,"spread":false}]],"params":[],"component":"/diagnostics","pathname":"/diagnostics","prerender":true,"redirect":{"status":301,"destination":"/contact"},"redirectRoute":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.astro","pathname":"/contact","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/glossary/[term]","isIndex":false,"type":"page","pattern":"^\\/glossary\\/([^/]+?)\\/?$","segments":[[{"content":"glossary","dynamic":false,"spread":false}],[{"content":"term","dynamic":true,"spread":false}]],"params":["term"],"component":"src/pages/glossary/[term].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/glossary","isIndex":true,"type":"page","pattern":"^\\/glossary\\/?$","segments":[[{"content":"glossary","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/glossary/index.astro","pathname":"/glossary","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/industry-solutions/[id]","isIndex":false,"type":"page","pattern":"^\\/industry-solutions\\/([^/]+?)\\/?$","segments":[[{"content":"industry-solutions","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/industry-solutions/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/industry-solutions","isIndex":true,"type":"page","pattern":"^\\/industry-solutions\\/?$","segments":[[{"content":"industry-solutions","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/industry-solutions/index.astro","pathname":"/industry-solutions","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/location/[id]","isIndex":false,"type":"page","pattern":"^\\/location\\/([^/]+?)\\/?$","segments":[[{"content":"location","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/location/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/locations/[state]/[city]","isIndex":false,"type":"page","pattern":"^\\/locations\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"locations","dynamic":false,"spread":false}],[{"content":"state","dynamic":true,"spread":false}],[{"content":"city","dynamic":true,"spread":false}]],"params":["state","city"],"component":"src/pages/locations/[state]/[city].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/locations","isIndex":false,"type":"page","pattern":"^\\/locations\\/?$","segments":[[{"content":"locations","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/locations.astro","pathname":"/locations","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/partners/partner-program","isIndex":false,"type":"page","pattern":"^\\/partners\\/partner-program\\/?$","segments":[[{"content":"partners","dynamic":false,"spread":false}],[{"content":"partner-program","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/partners/partner-program.astro","pathname":"/partners/partner-program","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/partners","isIndex":true,"type":"page","pattern":"^\\/partners\\/?$","segments":[[{"content":"partners","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/partners/index.astro","pathname":"/partners","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/pricing","isIndex":false,"type":"page","pattern":"^\\/pricing\\/?$","segments":[[{"content":"pricing","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/pricing.astro","pathname":"/pricing","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/privacy","isIndex":false,"type":"page","pattern":"^\\/privacy\\/?$","segments":[[{"content":"privacy","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/privacy.astro","pathname":"/privacy","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/problem/[id]","isIndex":false,"type":"page","pattern":"^\\/problem\\/([^/]+?)\\/?$","segments":[[{"content":"problem","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/problem/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/problems","isIndex":false,"type":"page","pattern":"^\\/problems\\/?$","segments":[[{"content":"problems","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/problems.astro","pathname":"/problems","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/product/[id]","isIndex":false,"type":"page","pattern":"^\\/product\\/([^/]+?)\\/?$","segments":[[{"content":"product","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/product/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/products","isIndex":false,"type":"page","pattern":"^\\/products\\/?$","segments":[[{"content":"products","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/products.astro","pathname":"/products","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/resources/blog/[id]","isIndex":false,"type":"page","pattern":"^\\/resources\\/blog\\/([^/]+?)\\/?$","segments":[[{"content":"resources","dynamic":false,"spread":false}],[{"content":"blog","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/resources/blog/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/resources/blog","isIndex":true,"type":"page","pattern":"^\\/resources\\/blog\\/?$","segments":[[{"content":"resources","dynamic":false,"spread":false}],[{"content":"blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/resources/blog/index.astro","pathname":"/resources/blog","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/resources/faqs","isIndex":false,"type":"page","pattern":"^\\/resources\\/faqs\\/?$","segments":[[{"content":"resources","dynamic":false,"spread":false}],[{"content":"faqs","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/resources/faqs.astro","pathname":"/resources/faqs","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/roi-calculator","pattern":"^\\/roi-calculator\\/?$","segments":[[{"content":"roi-calculator","dynamic":false,"spread":false}]],"params":[],"component":"/roi-calculator","pathname":"/roi-calculator","prerender":true,"redirect":{"status":301,"destination":"/pricing"},"redirectRoute":{"route":"/pricing","isIndex":false,"type":"page","pattern":"^\\/pricing\\/?$","segments":[[{"content":"pricing","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/pricing.astro","pathname":"/pricing","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/sandbox","isIndex":false,"type":"page","pattern":"^\\/sandbox\\/?$","segments":[[{"content":"sandbox","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/sandbox.astro","pathname":"/sandbox","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/search-growth/aeo","pattern":"^\\/search-growth\\/aeo\\/?$","segments":[[{"content":"search-growth","dynamic":false,"spread":false}],[{"content":"aeo","dynamic":false,"spread":false}]],"params":[],"component":"/search-growth/aeo","pathname":"/search-growth/aeo","prerender":true,"redirect":{"status":301,"destination":"/search-growth/aeo-services"},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/search-growth/geo","pattern":"^\\/search-growth\\/geo\\/?$","segments":[[{"content":"search-growth","dynamic":false,"spread":false}],[{"content":"geo","dynamic":false,"spread":false}]],"params":[],"component":"/search-growth/geo","pathname":"/search-growth/geo","prerender":true,"redirect":{"status":301,"destination":"/search-growth/geo-services"},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/search-growth/seo","pattern":"^\\/search-growth\\/seo\\/?$","segments":[[{"content":"search-growth","dynamic":false,"spread":false}],[{"content":"seo","dynamic":false,"spread":false}]],"params":[],"component":"/search-growth/seo","pathname":"/search-growth/seo","prerender":true,"redirect":{"status":301,"destination":"/search-growth/seo-services"},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/seo-tools","pattern":"^\\/seo-tools\\/?$","segments":[[{"content":"seo-tools","dynamic":false,"spread":false}]],"params":[],"component":"/seo-tools","pathname":"/seo-tools","prerender":true,"redirect":{"status":301,"destination":"/search-growth/seo-services"},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"},{"type":"inline","content":".service-card[data-astro-cid-lnthwwyx]{transition:opacity .6s ease-out,transform .6s ease-out}\n"}],"routeData":{"route":"/services","isIndex":false,"type":"page","pattern":"^\\/services\\/?$","segments":[[{"content":"services","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/services.astro","pathname":"/services","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/sitemap","isIndex":false,"type":"page","pattern":"^\\/sitemap\\/?$","segments":[[{"content":"sitemap","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/sitemap.astro","pathname":"/sitemap","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/social-media","isIndex":false,"type":"page","pattern":"^\\/social-media\\/?$","segments":[[{"content":"social-media","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/social-media.astro","pathname":"/social-media","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/solution/[id]","isIndex":false,"type":"page","pattern":"^\\/solution\\/([^/]+?)\\/?$","segments":[[{"content":"solution","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/solution/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"},{"type":"inline","content":".solution-card[data-astro-cid-p7bpkpvw]{transition:opacity .6s ease-out,transform .6s ease-out}\n"}],"routeData":{"route":"/solutions","isIndex":false,"type":"page","pattern":"^\\/solutions\\/?$","segments":[[{"content":"solutions","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/solutions.astro","pathname":"/solutions","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/team/[name]","isIndex":false,"type":"page","pattern":"^\\/team\\/([^/]+?)\\/?$","segments":[[{"content":"team","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"params":["name"],"component":"src/pages/team/[name].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/technology-consultancy","isIndex":false,"type":"page","pattern":"^\\/technology-consultancy\\/?$","segments":[[{"content":"technology-consultancy","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/technology-consultancy.astro","pathname":"/technology-consultancy","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/terms","isIndex":false,"type":"page","pattern":"^\\/terms\\/?$","segments":[[{"content":"terms","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/terms.astro","pathname":"/terms","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/three-demo","isIndex":false,"type":"page","pattern":"^\\/three-demo\\/?$","segments":[[{"content":"three-demo","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/three-demo.astro","pathname":"/three-demo","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/[categoryId]/[serviceId]/[state]/[city]","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"categoryId","dynamic":true,"spread":false}],[{"content":"serviceId","dynamic":true,"spread":false}],[{"content":"state","dynamic":true,"spread":false}],[{"content":"city","dynamic":true,"spread":false}]],"params":["categoryId","serviceId","state","city"],"component":"src/pages/[categoryId]/[serviceId]/[state]/[city].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/[categoryId]/[serviceId]","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"categoryId","dynamic":true,"spread":false}],[{"content":"serviceId","dynamic":true,"spread":false}]],"params":["categoryId","serviceId"],"component":"src/pages/[categoryId]/[serviceId].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"}],"routeData":{"route":"/[categoryId]","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/?$","segments":[[{"content":"categoryId","dynamic":true,"spread":false}]],"params":["categoryId"],"component":"src/pages/[categoryId].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"assets/page.Cyd3g14u.js"}],"styles":[{"type":"external","src":"assets/BaseLayout.BvDC1VOh.css"},{"type":"inline","content":"@keyframes fadeInUp{0%{opacity:0;transform:translateY(40px)}to{opacity:1;transform:translate(0,0)}}@keyframes float{0%{transform:translateY(0)}50%{transform:translateY(-20px)}to{transform:translateY(0)}}.animate-fade-in-up[data-astro-cid-lcdefpme]{will-change:transform, opacity;animation:.8s ease-out forwards fadeInUp}.animate-float[data-astro-cid-lcdefpme]{will-change:transform;animation:6s ease-in-out infinite float}.delay-100[data-astro-cid-lcdefpme]{animation-delay:.1s}.delay-200[data-astro-cid-lcdefpme]{animation-delay:.2s}.delay-300[data-astro-cid-lcdefpme]{animation-delay:.3s}@keyframes morphGradient{0%{--mesh-color-1:#030014;--mesh-color-2:#0b0826;--mesh-color-3:#040118}50%{--mesh-color-1:#080436;--mesh-color-2:#1e1b4b;--mesh-color-3:#0f172a}to{--mesh-color-1:#030014;--mesh-color-2:#0b0826;--mesh-color-3:#040118}}.fallback-gradient-animated[data-astro-cid-lcdefpme]{animation:12s ease-in-out infinite morphGradient}@media (prefers-reduced-motion:reduce){.animate-fade-in-up[data-astro-cid-lcdefpme]{opacity:1!important;will-change:auto!important;animation:none!important;transform:none!important}.animate-float[data-astro-cid-lcdefpme]{will-change:auto!important;animation:none!important;transform:none!important}.fallback-gradient-animated[data-astro-cid-lcdefpme]{animation:none!important}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":false,"middlewareMode":"classic","site":"https://webworldmaker.com","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/apple/Downloads/webworldmaker/src/pages/403.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/404.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/500.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/[categoryId].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/[categoryId]/[serviceId].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/[categoryId]/[serviceId]/[state]/[city].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/admin/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/case-studies.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/company/about.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/company/careers.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/company/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/compare/[id].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/compare/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/contact.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/corrections.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/developer/api-reference.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/glossary/[term].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/glossary/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/industry-solutions/[id].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/industry-solutions/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/location/[id].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/locations.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/locations/[state]/[city].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/partners/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/partners/partner-program.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/pricing.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/privacy.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/problem/[id].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/problems.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/product/[id].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/products.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/resources/blog/[id].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/resources/blog/index.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/resources/faqs.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/sandbox.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/services.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/sitemap.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/social-media.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/solution/[id].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/solutions.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/team/[name].astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/technology-consultancy.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/terms.astro",{"propagation":"none","containsHead":true}],["/Users/apple/Downloads/webworldmaker/src/pages/three-demo.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.D5GnRr3Q.mjs","\u0000virtual:astro:page:src/pages/403@_@astro":"chunks/403_DGzgq6aQ.mjs","\u0000virtual:astro:page:src/pages/404@_@astro":"chunks/404_BhE_gwGp.mjs","\u0000virtual:astro:page:src/pages/500@_@astro":"chunks/500_BCcSiJOY.mjs","\u0000virtual:astro:page:src/pages/ai/[...slug]@_@ts":"chunks/_.._Kz8t1zzF.mjs","\u0000virtual:astro:page:src/pages/[categoryId]@_@astro":"chunks/_categoryId__BNQqGdft.mjs","\u0000virtual:astro:page:src/pages/[categoryId]/[serviceId]/[state]/[city]@_@astro":"chunks/_city__CTe1Ms3o.mjs","\u0000virtual:astro:page:src/pages/locations/[state]/[city]@_@astro":"chunks/_city__DmCJ3r5a.mjs","\u0000virtual:astro:page:src/pages/industry-solutions/[id]@_@astro":"chunks/_id__0bxdrhoE.mjs","\u0000virtual:astro:page:src/pages/compare/[id]@_@astro":"chunks/_id__BM4cmcI2.mjs","\u0000virtual:astro:page:src/pages/problem/[id]@_@astro":"chunks/_id__BnbxG9qh.mjs","\u0000virtual:astro:page:src/pages/location/[id]@_@astro":"chunks/_id__CrWlCH_g.mjs","\u0000virtual:astro:page:src/pages/solution/[id]@_@astro":"chunks/_id__DvaPdsHN.mjs","\u0000virtual:astro:page:src/pages/product/[id]@_@astro":"chunks/_id__EI2HMIEL.mjs","\u0000virtual:astro:page:src/pages/resources/blog/[id]@_@astro":"chunks/_id__yPta7d3N.mjs","\u0000virtual:astro:page:src/pages/team/[name]@_@astro":"chunks/_name__BHCRZ6dH.mjs","\u0000noop-middleware":"chunks/_noop-middleware_CQ50ikAJ.mjs","\u0000virtual:astro:page:src/pages/[categoryId]/[serviceId]@_@astro":"chunks/_serviceId__BfCEx1Kl.mjs","\u0000virtual:astro:page:src/pages/glossary/[term]@_@astro":"chunks/_term__Cps2wW0q.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/company/about@_@astro":"chunks/about_DCM781mt.mjs","\u0000virtual:astro:page:src/pages/developer/api-reference@_@astro":"chunks/api-reference_A7etqP9R.mjs","\u0000virtual:astro:page:src/pages/company/careers@_@astro":"chunks/careers_k-qTp6ba.mjs","\u0000virtual:astro:page:src/pages/case-studies@_@astro":"chunks/case-studies_rh7kotsI.mjs","\u0000virtual:astro:page:src/pages/contact@_@astro":"chunks/contact_CcveUQPz.mjs","\u0000virtual:astro:page:src/pages/corrections@_@astro":"chunks/corrections_GRQ3ck_2.mjs","\u0000virtual:astro:page:src/pages/resources/faqs@_@astro":"chunks/faqs_5z7EvlwU.mjs","\u0000virtual:astro:page:src/pages/partners/index@_@astro":"chunks/index_83jSE0HG.mjs","\u0000virtual:astro:page:src/pages/resources/blog/index@_@astro":"chunks/index_B5TjvVg5.mjs","\u0000virtual:astro:page:src/pages/company/index@_@astro":"chunks/index_BKvwvEyY.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_BLgCVe53.mjs","\u0000virtual:astro:page:src/pages/compare/index@_@astro":"chunks/index_CC_uFPZN.mjs","\u0000virtual:astro:page:src/pages/industry-solutions/index@_@astro":"chunks/index_D1_AaGZu.mjs","\u0000virtual:astro:page:src/pages/glossary/index@_@astro":"chunks/index_Dsj8Yru5.mjs","\u0000virtual:astro:page:src/pages/admin/index@_@astro":"chunks/index_Dts89SyA.mjs","\u0000virtual:astro:page:src/pages/locations@_@astro":"chunks/locations_D9oNJEMS.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","\u0000virtual:astro:page:src/pages/partners/partner-program@_@astro":"chunks/partner-program_COgVbDMy.mjs","\u0000virtual:astro:page:src/pages/pricing@_@astro":"chunks/pricing_CO7rD0zj.mjs","\u0000virtual:astro:page:src/pages/privacy@_@astro":"chunks/privacy_Cnc14ZYc.mjs","\u0000virtual:astro:page:src/pages/problems@_@astro":"chunks/problems_CGKlCjKG.mjs","\u0000virtual:astro:page:src/pages/products@_@astro":"chunks/products_B8jgjtVO.mjs","\u0000virtual:astro:page:src/pages/sandbox@_@astro":"chunks/sandbox_Bedr69VP.mjs","\u0000virtual:astro:page:src/pages/services@_@astro":"chunks/services_BnzGpRNG.mjs","\u0000virtual:astro:page:src/pages/sitemap@_@astro":"chunks/sitemap_DP9tKmsk.mjs","\u0000virtual:astro:page:src/pages/social-media@_@astro":"chunks/social-media_BNeBcYEJ.mjs","\u0000virtual:astro:page:src/pages/solutions@_@astro":"chunks/solutions_BgoWBSDI.mjs","\u0000virtual:astro:page:src/pages/technology-consultancy@_@astro":"chunks/technology-consultancy_5YJwkh9T.mjs","\u0000virtual:astro:page:src/pages/terms@_@astro":"chunks/terms_02gYp8-a.mjs","\u0000virtual:astro:page:src/pages/three-demo@_@astro":"chunks/three-demo_CV5GkSam.mjs","/Users/apple/Downloads/webworldmaker/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","/Users/apple/Downloads/webworldmaker/src/components/AdminDashboardIsland.tsx":"assets/AdminDashboardIsland.0mY0rgTP.js","/Users/apple/Downloads/webworldmaker/src/layouts/BaseLayout.astro?astro&type=script&index=0&lang.ts":"assets/BaseLayout.astro_astro_type_script_index_0_lang.BcjUSZVA.js","/Users/apple/Downloads/webworldmaker/src/components/ComparisonFormIsland.tsx":"assets/ComparisonFormIsland.CmEnr70t.js","/Users/apple/Downloads/webworldmaker/src/components/ContactFormIsland.tsx":"assets/ContactFormIsland.DVO1vPcc.js","/Users/apple/Downloads/webworldmaker/src/components/CookieConsent.tsx":"assets/CookieConsent.CPm4evuG.js","/Users/apple/Downloads/webworldmaker/src/components/DashboardTelemetry.tsx":"assets/DashboardTelemetry.BUpAG1MC.js","/Users/apple/Downloads/webworldmaker/src/components/FaqAccordion.tsx":"assets/FaqAccordion.DhemXWl1.js","/Users/apple/Downloads/webworldmaker/src/components/FaqHubIsland.tsx":"assets/FaqHubIsland.CF-2NyEV.js","/Users/apple/Downloads/webworldmaker/src/components/FloatingShareSidebar.tsx":"assets/FloatingShareSidebar.BGvhIZK7.js","/Users/apple/Downloads/webworldmaker/src/components/Footer.tsx":"assets/Footer.CGQVyxNe.js","/Users/apple/Downloads/webworldmaker/src/components/HinglishContent.tsx":"assets/HinglishContent.kkB-6e-h.js","/Users/apple/Downloads/webworldmaker/src/components/LiquidMesh3D.tsx":"assets/LiquidMesh3D.BZthUsbJ.js","/Users/apple/Downloads/webworldmaker/src/components/LocationsDirectoryIsland.tsx":"assets/LocationsDirectoryIsland.9kq46uk5.js","/Users/apple/Downloads/webworldmaker/src/components/Navigation.tsx":"assets/Navigation.CfiuJbbI.js","/Users/apple/Downloads/webworldmaker/src/components/PricingCalculatorIsland.tsx":"assets/PricingCalculatorIsland.xm4V3JUq.js","/Users/apple/Downloads/webworldmaker/src/components/ProductSidebarForm.tsx":"assets/ProductSidebarForm.DHZK314d.js","/Users/apple/Downloads/webworldmaker/src/components/ProsConsTable.tsx":"assets/ProsConsTable.DnFLGcKH.js","/Users/apple/Downloads/webworldmaker/src/components/SandboxIsland.tsx":"assets/SandboxIsland.dIk06THu.js","/Users/apple/Downloads/webworldmaker/src/components/ServiceSidebarForm.tsx":"assets/ServiceSidebarForm.MY0TDT4H.js","/Users/apple/Downloads/webworldmaker/src/components/SitemapIsland.tsx":"assets/SitemapIsland.CEGHVQKf.js","/Users/apple/Downloads/webworldmaker/src/components/SocialMediaNewsletterIsland.tsx":"assets/SocialMediaNewsletterIsland.gXYDeje7.js","/Users/apple/Downloads/webworldmaker/src/components/SocialShare.tsx":"assets/SocialShare.VZ-Ne7N-.js","/Users/apple/Downloads/webworldmaker/src/components/SolutionSection.tsx":"assets/SolutionSection.WJHVN6qM.js","/Users/apple/Downloads/webworldmaker/src/components/SolutionSidebarForm.tsx":"assets/SolutionSidebarForm.CUBcz1Wb.js","/Users/apple/Downloads/webworldmaker/src/components/TechnologyConsultancy.tsx":"assets/TechnologyConsultancy.Cri86FjB.js","/Users/apple/Downloads/webworldmaker/src/components/ThreeDemoIsland.tsx":"assets/ThreeDemoIsland.n4gtSsEL.js","/Users/apple/Downloads/webworldmaker/src/pages/locations/[state]/[city].astro?astro&type=script&index=0&lang.ts":"assets/_city_.astro_astro_type_script_index_0_lang.DyvWbgG8.js","/Users/apple/Downloads/webworldmaker/src/pages/locations/[state]/[city].astro?astro&type=script&index=1&lang.ts":"assets/_city_.astro_astro_type_script_index_1_lang.CCZJWGgp.js","/Users/apple/Downloads/webworldmaker/src/pages/[categoryId]/[serviceId].astro?astro&type=script&index=0&lang.ts":"assets/_serviceId_.astro_astro_type_script_index_0_lang.BPDYXQIs.js","@astrojs/react/client.js":"assets/client.CaUKYcJG.js","/Users/apple/Downloads/webworldmaker/src/pages/resources/blog/index.astro?astro&type=script&index=0&lang.ts":"assets/index.astro_astro_type_script_index_0_lang.C7yrpgWz.js","astro:scripts/page.js":"assets/page.Cyd3g14u.js","/Users/apple/Downloads/webworldmaker/src/pages/services.astro?astro&type=script&index=0&lang.ts":"assets/services.astro_astro_type_script_index_0_lang.nhnnr1UH.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/apple/Downloads/webworldmaker/src/pages/locations/[state]/[city].astro?astro&type=script&index=0&lang.ts","function e(){let e=0,t=0,n=0,r=document.getElementById(`cta-contact-btn`);if(!r)return;let i=a=>{let o=performance.now();if(n>0){let s=o-n;if(s>0){let n=a.clientX-e,o=a.clientY-t,c=Math.sqrt(n*n+o*o)/s,l=r.getBoundingClientRect(),u=l.left+l.width/2,d=l.top+l.height/2,f=Math.sqrt((u-e)**2+(d-t)**2),p=Math.sqrt((u-a.clientX)**2+(d-a.clientY)**2);if(c>.5&&p<f&&p<500){let e=document.createElement(`link`);e.rel=`prefetch`,e.href=`/contact`,document.head.appendChild(e),document.removeEventListener(`mousemove`,i)}}}e=a.clientX,t=a.clientY,n=o};document.addEventListener(`mousemove`,i,{passive:!0})}document.addEventListener(`DOMContentLoaded`,e);"],["/Users/apple/Downloads/webworldmaker/src/pages/locations/[state]/[city].astro?astro&type=script&index=1&lang.ts","function e(){let e=document.getElementById(`hinglish-toggle-btn`),t=document.querySelectorAll(`[data-lang=\"en\"]`),n=document.querySelectorAll(`[data-lang=\"hin\"]`);if(!e)return;let r=localStorage.getItem(`wwm-lang`)===`hin`,i=()=>{t.forEach(e=>e.style.display=r?`none`:``),n.forEach(e=>e.style.display=r?``:`none`),e.textContent=r?`🇬🇧 English`:`🇮🇳 Hinglish`,e.setAttribute(`aria-pressed`,String(r))};e.addEventListener(`click`,()=>{r=!r,localStorage.setItem(`wwm-lang`,r?`hin`:`en`),i()}),i()}document.addEventListener(`DOMContentLoaded`,e);"],["/Users/apple/Downloads/webworldmaker/src/pages/[categoryId]/[serviceId].astro?astro&type=script&index=0&lang.ts","function e(){let e=document.querySelectorAll(`[id^=\"hinglish-toggle-btn\"]`),t=document.querySelectorAll(`[data-lang=\"en\"]`),n=document.querySelectorAll(`[data-lang=\"hin\"]`);if(e.length===0)return;let r=localStorage.getItem(`wwm-lang`)===`hin`,i=()=>{t.forEach(e=>e.style.display=r?`none`:``),n.forEach(e=>e.style.display=r?``:`none`),e.forEach(e=>{e.innerHTML=r?`🇬🇧 English`:`🇮🇳 Hinglish`})};e.forEach(e=>{e.addEventListener(`click`,()=>{r=!r,localStorage.setItem(`wwm-lang`,r?`hin`:`en`),i()})}),i()}document.addEventListener(`DOMContentLoaded`,e);"],["/Users/apple/Downloads/webworldmaker/src/pages/resources/blog/index.astro?astro&type=script&index=0&lang.ts","var e=document.querySelectorAll(`[data-category-filter]`),t=document.querySelectorAll(`[data-post-category]`),n=document.getElementById(`no-posts-alert`),r=document.getElementById(`reset-filter-btn`);function i(r){e.forEach(e=>{e.getAttribute(`data-category-filter`)===r?(e.classList.add(`bg-indigo-600`,`text-white`),e.classList.remove(`bg-white`,`text-slate-700`)):(e.classList.remove(`bg-indigo-600`,`text-white`),e.classList.add(`bg-white`,`text-slate-700`))});let i=0;t.forEach(e=>{let t=e.getAttribute(`data-post-category`);r===`All`||t===r?(e.classList.remove(`hidden`),i++):e.classList.add(`hidden`)}),i===0?n?.classList.remove(`hidden`):n?.classList.add(`hidden`)}e.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-category-filter`);t&&i(t)})}),r?.addEventListener(`click`,()=>{i(`All`)});"],["/Users/apple/Downloads/webworldmaker/src/pages/services.astro?astro&type=script&index=0&lang.ts","document.getElementById(`ask-ai-assistant-btn`)?.addEventListener(`click`,()=>{let e=document.querySelector(`button[class*=\"animate-bounce\"], .global-chat-trigger`);e?e.click():console.log(`AI Assistant widget trigger not found in the DOM.`)});"]],"assets":["/assets/BaseLayout.BvDC1VOh.css","/assets/page.Cyd3g14u.js","/file:///Users/apple/Downloads/webworldmaker/dist/403/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/404.html","/file:///Users/apple/Downloads/webworldmaker/dist/500.html","/file:///Users/apple/Downloads/webworldmaker/dist/about/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/admin/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/careers/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/case-studies/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/company/about/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/company/about-us/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/company/careers/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/company/contact/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/company/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/compare/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/contact/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/contact-us/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/corrections/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/developer/api-reference/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/diagnostics/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/glossary/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/industry-solutions/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/locations/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/partners/partner-program/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/partners/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/pricing/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/privacy/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/problems/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/products/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/resources/blog/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/resources/faqs/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/roi-calculator/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/sandbox/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/search-growth/aeo/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/search-growth/geo/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/search-growth/seo/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/seo-tools/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/services/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/sitemap/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/social-media/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/solutions/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/technology-consultancy/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/terms/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/three-demo/index.html","/file:///Users/apple/Downloads/webworldmaker/dist/index.html"],"buildFormat":"directory","checkOrigin":false,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"fudV9DHxQOdxsr8z7h/nk9yy0iZy7DNfk59uxrYg0pc=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
